...
namespace ProLEGO.Models
{
    ...
    public class ProjectVM
    {
        ...
        public static bool CreateProject(string machine,string ProjectName)
        {
            ...
            {
                var sql = "insert into ProjectVM(ProjectName,ColumnName,ColumnID,ColumnValue,UpdateTime) values(N'<ProjectName>',N'<ColumnName>',N'<ColumnID>',N'<ColumnValue>',N'<UpdateTime>')";
        ...
        {
            var sql = "select ProjectName from ProjectVM where ProjectName = N'<ProjectName>'";
        ...
        public static void UpdateProjectColumnValue(string machine,string ProjectName, string ColumnName, string Value)
        {
            ...
            var sql = "update ProjectVM set ColumnValue = N'<ColumnValue>' where  ProjectName = N'<ProjectName>' and ColumnName=N'<ColumnName>'";
        ...
        public static ProjectVM RetriveProjectData(string pjname, List<ProjectColumn> defcols,string machinename)
        {
            ...
            var sql = "select ProjectName,ColumnName,ColumnValue,UpdateTime from ProjectVM where ProjectName = N'<ProjectName>'";
